...
import com.beautysight.liurushi.social.app.FollowersPresentation;
import com.beautysight.liurushi.social.app.FollowingsPresentation;
...
public class FollowRest {
    ...
    public void follow(@RequestBody FollowOrNotCommand command) {
        command.followerId = RequestContext.getUser().idAsStr();
        command.validate();
    ...
    public FollowersPresentation getFollowersOf(@RequestParam String userId,
    ...
    @VisitorApiPermission
    public FollowingsPresentation getFollowingsOf(@RequestParam String userId,
                                                 @RequestParam(required = false) String referencePoint,
                                                 @RequestParam Integer offset,
                                                 @RequestParam(required = false) OffsetDirection direction) {
        Range range = new Range(referencePoint, offset, direction);
